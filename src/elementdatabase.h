...
namespace edb
{
	...
	private:
		...
		typedef QHash<KeyType, edb::Element::Ptr> ElementHash;
	...
	public:
		...
		friend std::ostream& std::operator<<(std::ostream& o, const ElementDatabase& db);
	private:
